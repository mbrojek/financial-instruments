...
1. **Definicja, rodzaje oraz własności opcji**
...
**Opcja sprzedaży** (_put option_)- prawo sprzedaży (ale nie obowiązek) określonej ilości instrumentu podstawowego po ustalonej cenie w ustalonym okresie.
...
2.  Podział opcji ze względu na termin wygaśnięcia
...
1. Podstawowe rodzaje transakcji na rynku opcji
...
- W przypadku, gdzie kurs euro będzie poniżej 4,15 pln, to operacja nie zostanie wykonana, ponieważ nie ma sensu kupowanie opcji po 4,15 pln za 1 euro, jeżeli ich aktualna  cena rynkowa jest niższa. W tej sytuacji posiadacz opcji straci całą sumę wydatkowaną na zakup opcji, czyli 600 pln.
- W przypadku, gdzie kurs euro będzie powyżej 4,15 pln, to operacja zostanie wykonana, ponieważ opłaca się kupić  opcję po cenie wykonania, która jest niższa od obecnej ceny rynkowej. Załóżmy, że kurs euro wynosi 4,22 pln. Łatwo policzyć , że zysk tej transakcji bez kosztów operacyjnych wyniesie 700 pln. Odejmując od tej kwoty koszty początkowe (czyli 600 pln), otrzymamy zysk netto równy 100 pln.
- W przypadku, gdzie kurs euro zostanie na tym samym poziomie (tzn. 1 euro= 4,15 pln), to nie ma znaczenia czy wypłata zostanie wykonana czy nie. Wypłata w obydwu sytuacjach będzie wynosić 0. 
...
Analizując powyższe przykłady możemy zauważyć pewne analogie. Łatwo zauważyć , że krótkie opcje sprzedaży i kupna są symetryczne (zakładając, że mają takie same parametry).
...
2. T. Jóźwik; Wprowadzenie do opcji giełdowych.
3. ffffff
							|
